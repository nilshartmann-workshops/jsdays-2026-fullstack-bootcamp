...
import { DbBook, DbCreateBook } from '../modules/books/books.types';
import { DbAuthor } from '../modules/authors/authors.types';
...
export type Resolvers<ContextType = BookStoreGraphQLContext> = ResolversObject<{
